...
t0=datenum(2020,04,23); % beginning of interval
tf=datenum(2020,04,23); % end of interval (same as above if only 1 day)
...
e40_pre=data.a(1:576001,1); e40_pre=e40_pre-mean(e40_pre);
